...
.then( function({products}) {
  const availableProduct = products.data;
  availableProduct.forEach(({name, images}) => 
  {
    const product_card = document.getElementById("products");
        product_card.innerHTML += `
            <div class="product_card flex_row">
                    <img src=${images[0]} />
                    <p>${name}</p>
                    <p>$9.99</p>
            </div>`;
